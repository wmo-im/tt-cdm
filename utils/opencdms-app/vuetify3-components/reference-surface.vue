<template>
  <v-card>
    ...
    <v-card-text>
        <v-form>
            <v-card-item><v-text-field label="id" v-model="referenceSurface.id" type="number" hint="" persistent-hint></v-text-field></v-card-item>
            <v-card-item><v-text-field label="name" v-model="referenceSurface.name" type="number" hint="" persistent-hint></v-text-field></v-card-item>

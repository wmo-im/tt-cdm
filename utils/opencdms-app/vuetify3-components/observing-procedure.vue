<template>
  <v-card>
    ...
    <v-card-text>
        <v-form>
            <v-card-item><v-text-field label="id" v-model="observingProcedure.id" type="number" hint="ID / primary key" persistent-hint></v-text-field></v-card-item>
            ...
            <v-card-item><v-text-field label="_change_date" v-model="observingProcedure._change_date"  hint="Date this record was changed" persistent-hint></v-text-field></v-card-item>

  ...
  <v-card>
    ...
    <v-card-text>
        <v-form>
            ...
            <v-card-item><v-text-field label="_change_date" v-model="collection._change_date"  hint="Date this record was changed" persistent-hint></v-text-field></v-card-item>
